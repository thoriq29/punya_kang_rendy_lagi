...
<script>
  $(document).ready(function() {
      ...
      $(document).on('click','.js-submit-confirm', function(e){
          e.preventDefault();
          swal({
            title: 'Apakah anda yakin ingin mengnonaktifkan?',
            // text: 'Data yang sudah dihapus, tidak dapat dikembalikan!',
            text: 'Data yang sudah di non aktifkan, tidak akan muncul pada menu order!',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
          })
      ...
      $(document).on('click','.js-submit-confirm-active', function(e){
          ...
          swal({
            ...
            // text: 'Data yang sudah dihapus, tidak dapat dikembalikan!',
            text: 'Data yang sudah diaktifkan, akan muncul pada menu order!',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
          })
