            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-6 {{ $errors->has('closing_date') ? ' has-error' : '' }}">
                  ...
                  <input id="closing_date" type="date" class="form-control @if ($errors->has('closing_date')) is-invalid @endif" name="closing_date" tabindex="1" value="{{ $package->closing_date }}">
