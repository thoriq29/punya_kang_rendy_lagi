...
@section('content')
  <section class="section">
    ...
    <form method="POST" action="{{ route('criteria.update', $criteria->id) }}" enctype="multipart/form-data">
      @csrf @method('PUT')
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-12 {{ $errors->has('name') ? ' has-error' : '' }}">
                  ...
                  <input id="name" type="text" class="form-control @if ($errors->has('name')) is-invalid @endif" name="name" tabindex="1" value="{{ $criteria->name }}">
                  @if ($errors->has('name'))
                ...
                <div class="form-group col-12 {{ $errors->has('weight') ? ' has-error' : '' }}">
                  ...
                  <input id="weight" type="number" class="form-control @if ($errors->has('weight')) is-invalid @endif" name="weight" tabindex="1" value="{{ $criteria->weight }}" max="100" onkeyup="checkMax(this)">
