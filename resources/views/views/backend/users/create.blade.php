            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-6 {{ $errors->has('email') ? ' has-error' : '' }}">
                  ...
                  <input id="email" type="email" class="form-control @if ($errors->has('email')) is-invalid @endif" name="email" tabindex="1" value="{{ old('email') }}">
                  @if ($errors->has('email'))
                    <div class="invalid-feedback">
                      {{ $errors->first('email') }}
                    </div>
              ...
              <div class="row">
                <div class="form-group col-5 {{ $errors->has('phone') ? ' has-error' : '' }}">
                  ...
                  <input id="phone" type="text" class="form-control @if ($errors->has('phone')) is-invalid @endif" name="phone" tabindex="1" value="{{ old('phone') }}">
                  @if ($errors->has('phone'))
                    <div class="invalid-feedback">
                      {{ $errors->first('phone') }}
                    </div>
                ...
                <div class="form-group col-7 {{ $errors->has('identity_card') ? ' has-error' : '' }}">
                  ...
                  <input id="identity_card" type="text" class="form-control @if ($errors->has('identity_card')) is-invalid @endif" name="identity_card" tabindex="1" value="{{ old('identity_card') }}">
            ...
            <div class="card-body">
              <div class="form-group">
                <div class="text-center">
                  <img src="{{ asset('assets/stisla/img/avatar/avatar.jpg') }}" class="rounded-circle" id="avatar-prev" width="200" height="200" alt="avatar">
                </div>
              </div>
